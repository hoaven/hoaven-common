...
public class CollectionUtils {
    ...
    /**
     * Return <code>true</code> if the supplied Collection is not <code>null</code> or empty. Otherwise, return
     * <code>false</code>.
     *
     * @param collection the Collection to check
    ...
    /**
     * Return <code>true</code> if the supplied Map is not<code>null</code> or empty. Otherwise, return
     * <code>false</code>.
     *
     * @param map the Map to check
